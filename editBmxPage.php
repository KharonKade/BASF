...
<body>
    <div class="admin-container">
        ...
        <?php
            ...
            $dbname_content = "u142318015_db_vf0t87O5";
        ...
        <div class="section-card">
            ...
            <form id="aboutUsForm" class="form-container" style="display:none;" method="post" action="handle_aboutus_bmx.php">
        ...
        <div class="section-card">
            ...
            <form id="addHighlightForm" class="form-container" style="display:none;" method="post" action="handle_highlight_bmx.php" enctype="multipart/form-data">
                    ...
                    <?php
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td style='text-align: right;'>
                                    ...
                                    <a href='handle_highlight_bmx.php?delete_id={$row['id']}' class='btn-danger btn-icon' style='text-decoration:none; display:inline-block;'><i class='fa fa-trash'></i></a>
                                </td>";
                            
                            echo "<tr id='editRow{$row['id']}' style='display:none;'>";
                            echo "<td colspan='4' style='padding:0;'>
                                    <div class='form-container' style='margin: 10px;'>
                                        <form method='post' action='handle_highlight_bmx.php' enctype='multipart/form-data'>
        ...
        <div class="section-card">
            ...
            <form id="addAthleteForm" class="form-container" style="display:none;" method="post" action="handle_athletes_bmx.php" enctype="multipart/form-data">
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                    <div>
                        <label>Name</label>
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<form id='editAthleteForm{$row['id']}' class='form-container' style='display:none;' method='post' action='handle_athletes_bmx.php' enctype='multipart/form-data'>";
        ...
        <div class="section-card">
            ...
            <form id="addLeaderForm" class="form-container" style="display: none;" method="POST" action="handle_leaders_bmx.php" enctype="multipart/form-data">
            ...
            <div class="grid-cards">
                ...
                if ($result && $result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<form method="POST" action="handle_leaders_bmx.php" style="display:inline;">
                                <input type="hidden" name="id" value="' . $row['id'] . '">
                        ...
                        echo '<form id="editLeaderForm' . $row['id'] . '" class="form-container" style="display: none; margin-top: 15px; text-align:left;" method="POST" action="handle_leaders_bmx.php" enctype="multipart/form-data">
        ...
        <div class="section-card">
            ...
            <form id="addPartnerForm" class="form-container" style="display: none;" method="POST" action="handle_partnerships_bmx.php" enctype="multipart/form-data">
            ...
            <div class="grid-cards">
                ...
                if ($result && $result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<form method="POST" action="handle_partnerships_bmx.php">
                                <input type="hidden" name="id" value="' . $row['id'] . '">
