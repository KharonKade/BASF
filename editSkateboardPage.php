...
<body>
    <div class="admin-container">
        ...
        <div class="section-card">
            ...
            <form id="aboutUsForm" class="form-container" style="display:none;" method="post" action="handle_aboutus_skateboard.php">
                ...
                <?php
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td style='text-align: right;'>
                                ...
                                <a href='handle_highlight_skateboard.php?delete_id={$row['id']}' class='btn-danger btn-icon' style='text-decoration:none; display:inline-block;' onclick='return confirm(\"Are you sure?\")'><i class='fa fa-trash'></i></a>
                            </td>";
            ...
            <div class="grid-cards">
                ...
                if ($result && $result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<form method="POST" action="handle_leaders_skateboard.php" style="display:inline;">
                                <input type="hidden" name="id" value="' . $row['id'] . '">
                        ...
                        echo '<form id="editLeaderForm' . $row['id'] . '" class="form-container" style="display: none; margin-top: 15px; text-align:left;" method="POST" action="handle_leaders_skateboard.php" enctype="multipart/form-data">
            ...
            <div class="grid-cards">
                ...
                if ($result && $result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<form method="POST" action="handle_partnerships_skateboard.php">
                                <input type="hidden" name="id" value="' . $row['id'] . '">
