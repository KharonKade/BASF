...
<body>
    ...
    <?php
     $conn_content = new mysqli("localhost", "u142318015_usr_vf0t87O4", "dmBI2c5QdB4*", "u142318015_db_vf0t87O5");
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    <div class="content">
                        <h1>' . $row["name"] . '</h1>
                        <p>' . $row["description"] . '</p>
                        <a href="playerPageBmx.php?id=' . $row['id'] . '" class="explore-btn">Check Athlete</a>
                    </div>
                  </div>';            
                }
            } else {
...
<script>
    ...
    <script>
        ...
        const pageName = "BMX"; // Change this on bmx.php and skateboard.php
